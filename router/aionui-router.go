...
func RegisterAionUiRouter(apiRouter *gin.RouterGroup) {
	aionUiRoute := apiRouter.Group("/aionui")
	{
		...
		aionUiRoute.GET("/client-packages/:id/download", middleware.AionUiClientPackageDownloadAuth(), controlleraionui.DownloadClientPackage)
		aionUiRoute.POST("/client-updates/access", middleware.AionUiOptionalDesktopAuth(), controlleraionui.PrepareClientUpdateAccess)
		aionUiRoute.GET("/client-updates/latest.yml", middleware.AionUiClientUpdateFeedAuth(), controlleraionui.GetClientUpdateFeed)
		aionUiRoute.GET("/client-updates/latest-mac.yml", middleware.AionUiClientUpdateFeedAuth(), controlleraionui.GetClientUpdateFeed)
		aionUiRoute.GET("/client-updates/latest-arm64-mac.yml", middleware.AionUiClientUpdateFeedAuth(), controlleraionui.GetClientUpdateFeed)
