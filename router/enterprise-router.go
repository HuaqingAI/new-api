...
func RegisterEnterpriseRouter(apiRouter *gin.RouterGroup) {
	...
	enterpriseRoute.Use(middleware.UserAuth())
	{
		...
		enterpriseRoute.GET("/public-budget-pools", middleware.EnterpriseAdmin(), controllerenterprise.ListPublicBudgetPools)
		enterpriseRoute.POST("/public-budget-pools", middleware.EnterpriseAdmin(), controllerenterprise.CreatePublicBudgetPool)
		enterpriseRoute.GET("/public-budget-pools/:id", middleware.EnterpriseAdmin(), controllerenterprise.GetPublicBudgetPool)
		enterpriseRoute.POST("/public-budget-pools/:id/pause", middleware.EnterpriseAdmin(), controllerenterprise.PausePublicBudgetPool)
		enterpriseRoute.POST("/public-budget-pools/:id/resume", middleware.EnterpriseAdmin(), controllerenterprise.ResumePublicBudgetPool)
		enterpriseRoute.POST("/public-budget-pools/:id/resize", middleware.EnterpriseAdmin(), controllerenterprise.ResizePublicBudgetPool)
		...
		enterpriseRoute.GET("/governance/timeline", controllerenterprise.ListGovernanceTimeline)
		enterpriseRoute.GET("/governance/notifications", controllerenterprise.ListGovernanceNotifications)
		enterpriseRoute.POST("/governance/notifications/:id/resend", controllerenterprise.ResendGovernanceNotification)
		...
		enterpriseRoute.POST("/usage/reports/send", middleware.EnterpriseAdmin(), controllerenterprise.SendDepartmentUsageReportNow)
