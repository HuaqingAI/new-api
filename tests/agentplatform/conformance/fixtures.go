...
func FixtureCatalog() []Fixture {
	return []Fixture{
		...
		detailFixture("detail_visible_callable", SkillResourceID, "skill", "published", "visible", "enabled", true, dtoagentplatform.OpenCapabilityDiagnostics{Reason: "fresh", Converged: true}),
		...
		refreshFixture("refresh_fresh", "fresh", "etag-skill-demo", dtoagentplatform.OpenCapabilityDiagnostics{Reason: "fresh", Converged: true}),
		refreshFixture("refresh_stale", "stale", "etag-skill-demo", dtoagentplatform.OpenCapabilityDiagnostics{Reason: "stale", Converged: true}),
		...
		refreshFixture("refresh_observed_etag_version_mismatch", "fresh", "etag-skill-demo-v2", dtoagentplatform.OpenCapabilityDiagnostics{Reason: "version_mismatch", Converged: false, ObservedETag: "etag-skill-demo", ObservedVersion: "0.9.0"}),
		refreshFixture("refresh_ttl_over_300_non_compliance", "stale", "etag-skill-demo", dtoagentplatform.OpenCapabilityDiagnostics{Reason: "client_observation_expired", Converged: false, ClientNonCompliant: true}),
		{
