...
function SlackIcon({ size = 20 }) {
  return (
    ...
    >
      <path
        d='M30.7 77.7c0 8.5-6.9 15.3-15.3 15.3S0 86.1 0 77.7s6.9-15.3 15.3-15.3h15.3v15.3Z'
        fill='#E01E5A'
      />
      <path
        d='M38.4 77.7c0-8.5 6.9-15.3 15.3-15.3S69 69.2 69 77.7v38.2c0 8.5-6.9 15.3-15.3 15.3s-15.3-6.9-15.3-15.3V77.7Z'
        fill='#E01E5A'
      />
      <path
        d='M53.7 30.7c-8.5 0-15.3-6.9-15.3-15.3S45.2 0 53.7 0 69 6.9 69 15.3v15.3H53.7Z'
        fill='#36C5F0'
      />
      <path
        d='M53.7 38.4c8.5 0 15.3 6.9 15.3 15.3S62.1 69 53.7 69H15.3C6.9 69 0 62.1 0 53.7s6.9-15.3 15.3-15.3h38.4Z'
        fill='#36C5F0'
      />
      <path
        d='M92 53.7c0-8.5 6.9-15.3 15.3-15.3s15.3 6.9 15.3 15.3S115.9 69 107.5 69H92V53.7Z'
        fill='#2EB67D'
      />
      <path
        d='M84.3 53.7c0 8.5-6.9 15.3-15.3 15.3S53.7 62.1 53.7 53.7V15.3C53.7 6.9 60.5 0 69 0s15.3 6.9 15.3 15.3v38.4Z'
        fill='#2EB67D'
      />
      <path
        d='M69 92c8.5 0 15.3 6.9 15.3 15.3s-6.9 15.3-15.3 15.3-15.3-6.9-15.3-15.3V92H69Z'
        fill='#ECB22E'
      />
      <path
        d='M69 84.3c-8.5 0-15.3-6.9-15.3-15.3S60.5 53.7 69 53.7h38.4c8.5 0 15.3 6.9 15.3 15.3s-6.9 15.3-15.3 15.3H69Z'
        fill='#ECB22E'
      />
    </svg>
  );
