...
describe('Enterprise organization department tree workflow', () => {
  ...
  test('renders quota request rows with localized budget identity and request statuses', () => {
        ...
        <QuotaRequestTable
          ...
          items={[
            ...
            quotaRequest({
              ...
              status: 'fulfilled',
              department_budget_id: 12,
              budget_name: 'Engineering production',
              budget_type: 'balance',
              budget_department_name: 'Engineering',
            }),
            quotaRequest({
              id: 3,
              status: 'mystery_status',
    ...
    for (const expected of [
      ...
      'Balance Budget',
      'Budget organization: Engineering',
      'Budget #13',
      '120 quota',
      '80 quota',
      'Approx. $0.0002',
...
function quotaRequest(
  ...
  return {
    ...
    budget_type: overrides.budget_type,
    budget_department_id: overrides.budget_department_id,
    budget_department_name: overrides.budget_department_name,
